...
import { Movies, MovieDetails, TrailerInfo, Trailer } from '../../../types';
...
export async function getStaticProps({ params }: { params: { id: String } }) {
  ...
  const videos:TrailerInfo = await resVideo.json();
  // console.log(videos);


  // TODO: Type Trailer not working for (video:Trailer)
...
export default function MoviesPage({ movie, trailer }: { movie: MovieDetails; trailer: string }) {
  return (
